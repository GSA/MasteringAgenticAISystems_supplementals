...
**Notes.** The Videos column counts the videos shown under each chapter summary below, out of the unique direct links in [`Part_01_YoutubeVideos.md`]({{ site.repo_blob }}/videos/Part_01_YoutubeVideos.md) ("3 of 5"). A video is left out when its link is dead, embedding is disabled, or YouTube's title does not match the entry; see the [link check]({{ site.baseurl }}/videos/link-check/). Chapters can also list search suggestions instead of links.
...
- [`code_01_confidence_gate_class.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.1B_code_01_confidence_gate_class.py)
- [`code_02_risk_gate_class.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.1B_code_02_risk_gate_class.py)
...
- [`Multi_Agent_code_01_intake_agent.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.3_Multi_Agent_code_01_intake_agent.py)
- [`Multi_Agent_code_02_retrieval_agent.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.3_Multi_Agent_code_02_retrieval_agent.py)
- [`Multi_Agent_code_03_classification_agent.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.3_Multi_Agent_code_03_classification_agent.py)
- [`Multi_Agent_code_04_response_agent.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.3_Multi_Agent_code_04_response_agent.py)
- [`Multi_Agent_code_05_escalation_agent.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.3_Multi_Agent_code_05_escalation_agent.py)
- [`Multi_Agent_code_06_ticket_orchestrator.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.3_Multi_Agent_code_06_ticket_orchestrator.py)
- [`Multi_Agent_code_07_error_handling.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.3_Multi_Agent_code_07_error_handling.py)
- [`Multi_Agent_code_08_distributed_tracing.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.3_Multi_Agent_code_08_distributed_tracing.py)
- [`Multi_Agent_code_09_metrics.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.3_Multi_Agent_code_09_metrics.py)
...
- [`Memory_Perception_code_02_hybrid_memory_system.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.4_Memory_Perception_code_02_hybrid_memory_system.py)
- [`Memory_Perception_code_03_support_agent_integration.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.4_Memory_Perception_code_03_support_agent_integration.py)
...
- [`code_01_stateless_flight_agent.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.5B_code_01_stateless_flight_agent.py)
- [`code_02_stateful_flight_agent.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.5B_code_02_stateful_flight_agent.py)
- [`code_03_failure_recovery_demo.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.5B_code_03_failure_recovery_demo.py)
- [`code_04_support_agent_state_config.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.5B_code_04_support_agent_state_config.py)
- [`code_05_decision_nodes.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.5B_code_05_decision_nodes.py)
- [`code_06_branch_handlers.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.5B_code_06_branch_handlers.py)
- [`code_07_routing_graph_construction.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.5B_code_07_routing_graph_construction.py)
- [`code_08_execution_example.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.5B_code_08_execution_example.py)
...
- [`code_02_loop_detection_iteration.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.6_code_02_loop_detection_iteration.py)
- [`code_03_sequential_execution.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.6_code_03_sequential_execution.py)
- [`code_04_parallel_execution_asyncio.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.6_code_04_parallel_execution_asyncio.py)
- [`code_05_langgraph_parallel_graph.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.6_code_05_langgraph_parallel_graph.py)
- [`code_06_claim_state_fraud_detection.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.6_code_06_claim_state_fraud_detection.py)
- [`code_07_research_state_progress_tracking.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.6_code_07_research_state_progress_tracking.py)
...
- [`KG_code_01_neo4j_driver_initialization.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.7A_KG_code_01_neo4j_driver_initialization.py)
- [`KG_code_02_create_company_node.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.7A_KG_code_02_create_company_node.py)
- [`KG_code_03_create_investment_relationship.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.7A_KG_code_03_create_investment_relationship.py)
- [`KG_code_04_find_common_investors.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.7A_KG_code_04_find_common_investors.py)
- [`KG_code_05_find_conflict_of_interest.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.7A_KG_code_05_find_conflict_of_interest.py)
- [`KG_code_06_langchain_neo4j_setup.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.7A_KG_code_06_langchain_neo4j_setup.py)
- [`KG_code_07_langchain_query_execution.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.7A_KG_code_07_langchain_query_execution.py)
- [`KG_code_08_entity_extractor.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.7A_KG_code_08_entity_extractor.py)
- [`KG_code_09_relationship_extractor.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.7A_KG_code_09_relationship_extractor.py)
- [`KG_code_10_knowledge_graph_builder.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.7A_KG_code_10_knowledge_graph_builder.py)
- [`KG_code_11_knowledge_graph_builder_example.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.7A_KG_code_11_knowledge_graph_builder_example.py)
- [`KG_code_12_nemo_entity_extractor.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.7A_KG_code_12_nemo_entity_extractor.py)
...
- [`code_01_hybrid_compliance_analyzer_init.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.7B_code_01_hybrid_compliance_analyzer_init.py)
- [`code_02_hybrid_retrieve.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.7B_code_02_hybrid_retrieve.py)
- [`code_03_extract_entities_from_docs.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.7B_code_03_extract_entities_from_docs.py)
- [`code_04_answer_with_hybrid_context.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.7B_code_04_answer_with_hybrid_context.py)
- [`code_05_usage_example.py`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.7B_code_05_usage_example.py)
...
- [`code_01_kubernetes_deployment_metadata.yaml`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.8_code_01_kubernetes_deployment_metadata.yaml)
- [`code_02_deployment_spec_and_containers.yaml`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.8_code_02_deployment_spec_and_containers.yaml)
- [`code_03_health_checks_probes.yaml`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.8_code_03_health_checks_probes.yaml)
- [`code_04_load_balancer_service.yaml`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.8_code_04_load_balancer_service.yaml)
- [`code_05_horizontal_pod_autoscaler_config.yaml`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.8_code_05_horizontal_pod_autoscaler_config.yaml)
- [`code_06_autoscaler_behavior_policy.yaml`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.8_code_06_autoscaler_behavior_policy.yaml)
- [`code_07_multi_metric_autoscaling_targets.yaml`]({{ site.repo_blob }}/code_examples/Part_01_Chapter_1.8_code_07_multi_metric_autoscaling_targets.yaml)

</details>

### Additional worked examples

From [`more_examples/part_01/`]({{ site.repo_tree }}/more_examples/part_01):

- [`complex_workflow.py`]({{ site.repo_blob }}/more_examples/part_01/complex_workflow.py)
- [`distributed_caching.py`]({{ site.repo_blob }}/more_examples/part_01/distributed_caching.py)
- [`load_balanced_agents.py`]({{ site.repo_blob }}/more_examples/part_01/load_balanced_agents.py)
