---
title: "Part 2 — Framework & Tool Integration"
parent: Curriculum
nav_order: 2
permalink: /curriculum/part-02/
---
...
**Notes.** The Videos column counts the videos shown under each chapter summary below, out of the unique direct links in [`Part_02_YoutubeVideos.md`]({{ site.repo_blob }}/videos/Part_02_YoutubeVideos.md) ("3 of 5"). A video is left out when its link is dead, embedding is disabled, or YouTube's title does not match the entry; see the [link check]({{ site.baseurl }}/videos/link-check/). Chapters can also list search suggestions instead of links.
...
- [`Framework_Landscape_code_02_faq_langgraph_implementation.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.1_Framework_Landscape_code_02_faq_langgraph_implementation.py)
- [`Framework_Landscape_code_03_faq_langchain_implementation.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.1_Framework_Landscape_code_03_faq_langchain_implementation.py)
...
- [`LangGraph_code_01_complete_imports.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.2_LangGraph_code_01_complete_imports.py)
- [`LangGraph_code_02_state_schema_definition.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.2_LangGraph_code_02_state_schema_definition.py)
- [`LangGraph_code_03_code_generation_node.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.2_LangGraph_code_03_code_generation_node.py)
- [`LangGraph_code_04_test_execution_node.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.2_LangGraph_code_04_test_execution_node.py)
- [`LangGraph_code_05_error_analysis_node.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.2_LangGraph_code_05_error_analysis_node.py)
- [`LangGraph_code_06_state_graph_with_conditional_routing.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.2_LangGraph_code_06_state_graph_with_conditional_routing.py)
- [`LangGraph_code_07_execute_workflow.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.2_LangGraph_code_07_execute_workflow.py)
- [`LangGraph_code_08_routing_with_quality_check.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.2_LangGraph_code_08_routing_with_quality_check.py)
- [`LangGraph_code_09_checkpointing_configuration.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.2_LangGraph_code_09_checkpointing_configuration.py)
- [`LangGraph_code_10_time_travel_debugging.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.2_LangGraph_code_10_time_travel_debugging.py)
- [`LangGraph_code_11_simple_agent_executor.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.2_LangGraph_code_11_simple_agent_executor.py)
...
- [`LangChain_code_02_initialize_language_model.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.3_LangChain_code_02_initialize_language_model.py)
- [`LangChain_code_03_configure_conversation_memory.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.3_LangChain_code_03_configure_conversation_memory.py)
- [`LangChain_code_04_create_agent_with_prompt_template.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.3_LangChain_code_04_create_agent_with_prompt_template.py)
- [`LangChain_code_05_execute_queries_and_observe_reasoning.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.3_LangChain_code_05_execute_queries_and_observe_reasoning.py)
- [`LangChain_code_06_poor_tool_description.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.3_LangChain_code_06_poor_tool_description.py)
- [`LangChain_code_07_improved_tool_description.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.3_LangChain_code_07_improved_tool_description.py)
- [`LangChain_code_08_robust_web_search_with_error_handling.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.3_LangChain_code_08_robust_web_search_with_error_handling.py)
...
- [`MultiAgent_Frameworks_code_02_autogen_groupchat_orchestration.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.4_MultiAgent_Frameworks_code_02_autogen_groupchat_orchestration.py)
- [`MultiAgent_Frameworks_code_03_crewai_agent_definitions.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.4_MultiAgent_Frameworks_code_03_crewai_agent_definitions.py)
- [`MultiAgent_Frameworks_code_04_crewai_task_definitions.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.4_MultiAgent_Frameworks_code_04_crewai_task_definitions.py)
- [`MultiAgent_Frameworks_code_05_crewai_workflow_execution.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.4_MultiAgent_Frameworks_code_05_crewai_workflow_execution.py)
...
- [`Semantic_Kernel_code_01_service_registration_setup.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.5_Semantic_Kernel_code_01_service_registration_setup.py)
- [`Semantic_Kernel_code_02_customer_service_plugin.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.5_Semantic_Kernel_code_02_customer_service_plugin.py)
- [`Semantic_Kernel_code_03_semantic_sentiment_analysis.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.5_Semantic_Kernel_code_03_semantic_sentiment_analysis.py)
- [`Semantic_Kernel_code_04_native_lifetime_value.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.5_Semantic_Kernel_code_04_native_lifetime_value.py)
- [`Semantic_Kernel_code_05_combined_functions.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.5_Semantic_Kernel_code_05_combined_functions.py)
- [`Semantic_Kernel_code_06_function_calling_planner.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.5_Semantic_Kernel_code_06_function_calling_planner.py)
- [`Semantic_Kernel_code_07_function_descriptions.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.5_Semantic_Kernel_code_07_function_descriptions.py)
- [`Semantic_Kernel_code_08_function_choice_behavior.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.5_Semantic_Kernel_code_08_function_choice_behavior.py)
- [`Semantic_Kernel_code_09_enterprise_crm_plugin_init.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.5_Semantic_Kernel_code_09_enterprise_crm_plugin_init.py)
- [`Semantic_Kernel_code_10_native_crm_functions.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.5_Semantic_Kernel_code_10_native_crm_functions.py)
- [`Semantic_Kernel_code_11_semantic_crm_functions.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.5_Semantic_Kernel_code_11_semantic_crm_functions.py)
- [`Semantic_Kernel_code_12_plugin_orchestration_setup.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.5_Semantic_Kernel_code_12_plugin_orchestration_setup.py)
...
- [`02_weather_notification_chain.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.6_02_weather_notification_chain.py)
- [`03_parallel_tool_execution.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.6_03_parallel_tool_execution.py)
- [`04_nvidia_nim_configuration.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.6_04_nvidia_nim_configuration.py)
...
- [`01_clip_embedding_setup.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.7_01_clip_embedding_setup.py)
- [`02_neva_visual_qa.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.7_02_neva_visual_qa.py)
- [`03_deplot_chart_extraction.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.7_03_deplot_chart_extraction.py)
- [`04_image_routing_pipeline.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.7_04_image_routing_pipeline.py)
- [`05_whisper_audio_processor.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.7_05_whisper_audio_processor.py)
- [`06_audio_rag_system.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.7_06_audio_rag_system.py)
- [`07_audio_retrieval_demo.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.7_07_audio_retrieval_demo.py)
...
- [`01_retry_exponential_backoff.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.8_01_retry_exponential_backoff.py)
- [`02_model_router_fallback.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.8_02_model_router_fallback.py)
- [`03_graceful_degradation.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.8_03_graceful_degradation.py)
- [`04_circuit_breaker_pattern.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.8_04_circuit_breaker_pattern.py)
- [`05_resilient_financial_agent.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.8_05_resilient_financial_agent.py)
- [`06_langchain_error_handling.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.8_06_langchain_error_handling.py)
- [`07_langgraph_error_recovery.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.8_07_langgraph_error_recovery.py)
...
- [`batch_response_endpoint_code_01_batch_response_endpoint.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.9_batch_response_endpoint_code_01_batch_response_endpoint.py)
- [`disconnection_detection_code_05_disconnection_detection.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.9_disconnection_detection_code_05_disconnection_detection.py)
- [`error_handling_context_code_04_error_handling_context.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.9_error_handling_context_code_04_error_handling_context.py)
- [`langserve_basic_setup_code_07_langserve_basic_setup.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.9_langserve_basic_setup_code_07_langserve_basic_setup.py)
- [`langserve_rag_chain_code_08_langserve_rag_chain.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.9_langserve_rag_chain_code_08_langserve_rag_chain.py)
- [`latency_tracking_instrumentation_code_06_latency_tracking_instrumentation.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.9_latency_tracking_instrumentation_code_06_latency_tracking_instrumentation.py)
- [`sse_client_consumer_code_03_sse_client_consumer.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.9_sse_client_consumer_code_03_sse_client_consumer.py)
- [`stream_log_event_handler_code_09_stream_log_event_handler.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.9_stream_log_event_handler_code_09_stream_log_event_handler.py)
- [`streaming_response_setup_code_02_streaming_response_setup.py`]({{ site.repo_blob }}/code_examples/Part_02_Chapter_2.9_streaming_response_setup_code_02_streaming_response_setup.py)

</details>

### Additional worked examples

From [`more_examples/part_02/`]({{ site.repo_tree }}/more_examples/part_02):

- [`streaming_agent.py`]({{ site.repo_blob }}/more_examples/part_02/streaming_agent.py)
